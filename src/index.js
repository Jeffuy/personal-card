...
const data = {
	name: "Germán Cavani",
	nickname: "@JeffUy",
	titles: "Web developer. Frontend Development with ReactJS/NextJS.",
	subtitles: "Html | Css | Javascript | Git | React.js | NextJS |Python. Estudiante en Universidad ORT y Platzi.",
	description:
...
const social = () => {
	...
	let url = data?.socials?.map((social) => {
		return `<a href=${social?.url} target="_blank">
		<svg class="w-6 h-6 cursor-pointer text-gray-400 hover:text-${social?.color} fill-current"
			viewBox="${social?.viewbox}" xmlns="http://www.w3.org/2000/svg">
